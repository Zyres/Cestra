...
import org.cestra.db.statique.data.AccountData;
import org.cestra.db.statique.data.AnimationData;
import org.cestra.db.statique.data.Area_dataData;
import org.cestra.db.statique.data.BanipData;
import org.cestra.db.statique.data.ChallengeData;
import org.cestra.db.statique.data.CoffreData;
import org.cestra.db.statique.data.CommandeData;
import org.cestra.db.statique.data.CraftData;
import org.cestra.db.statique.data.DonjonData;
import org.cestra.db.statique.data.DropData;
import org.cestra.db.statique.data.Endfight_actionData;
import org.cestra.db.statique.data.ExperienceData;
import org.cestra.db.statique.data.Extra_monsterData;
import org.cestra.db.statique.data.Full_morphData;
import org.cestra.db.statique.data.GiftData;
import org.cestra.db.statique.data.GroupeData;
import org.cestra.db.statique.data.HdvData;
import org.cestra.db.statique.data.HouseData;
import org.cestra.db.statique.data.Interactive_objects_dataData;
import org.cestra.db.statique.data.ItemData;
import org.cestra.db.statique.data.Item_templateData;
import org.cestra.db.statique.data.ItemsetData;
import org.cestra.db.statique.data.Jobs_dataData;
import org.cestra.db.statique.data.MapData;
import org.cestra.db.statique.data.Mobgroups_fixData;
import org.cestra.db.statique.data.MonsterData;
import org.cestra.db.statique.data.Mountpark_dataData;
import org.cestra.db.statique.data.Mounts_dataData;
import org.cestra.db.statique.data.NpcData;
import org.cestra.db.statique.data.Npc_questionData;
import org.cestra.db.statique.data.Npc_reponses_actionData;
import org.cestra.db.statique.data.Npc_templateData;
import org.cestra.db.statique.data.ObjectsactionData;
import org.cestra.db.statique.data.ParoliData;
import org.cestra.db.statique.data.PetData;
import org.cestra.db.statique.data.Pets_dataData;
import org.cestra.db.statique.data.PlayerData;
import org.cestra.db.statique.data.Quest_dataData;
import org.cestra.db.statique.data.Quest_etapeData;
import org.cestra.db.statique.data.Quest_objectifData;
import org.cestra.db.statique.data.Quest_persoData;
import org.cestra.db.statique.data.RuneData;
import org.cestra.db.statique.data.SchemafightData;
import org.cestra.db.statique.data.Scripted_cellData;
import org.cestra.db.statique.data.ServerData;
import org.cestra.db.statique.data.SortData;
import org.cestra.db.statique.data.Subarea_dataData;
import org.cestra.db.statique.data.TutorielData;
import org.cestra.db.statique.data.ZaapData;
import org.cestra.db.statique.data.ZaapiData;
