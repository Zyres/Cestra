...
public class Trunk {
	...
	private Map<Integer, org.cestra.object.Object> object;

	public Trunk(final int id, final int houseId, final short mapId, final int cellId) {
		this.player = null;
		this.object = new TreeMap<Integer, org.cestra.object.Object>();
		this.id = id;
	...
	public Map<Integer, org.cestra.object.Object> getObject() {
		return this.object;
	}

	public void setObject(final Map<Integer, org.cestra.object.Object> object) {
		synchronized (this.object) {
		}
	...
	public String parseToTrunkPacket() {
		...
		synchronized (this.object) {
			for (final org.cestra.object.Object obj : this.object.values()) {
	...
	public void addInTrunk(final int guid, final int qua, final Player P) {
		...
		org.cestra.object.Object TrunkObj = this.getSimilarTrunkItem(PersoObj);
	...
	private org.cestra.object.Object getSimilarTrunkItem(final org.cestra.object.Object obj) {
		synchronized (this.object) {
			for (final org.cestra.object.Object value : this.object.values()) {
	...
	public String parseTrunkObjetsToDB() {
		...
		synchronized (this.object) {
			for (final Map.Entry<Integer, org.cestra.object.Object> entry : this.object.entrySet()) {
	...
	public void moveTrunkToBank(final Account Cbank) {
		synchronized (this.object) {
			for (final Map.Entry<Integer, org.cestra.object.Object> obj : this.object.entrySet()) {
