...
public class Action {
	...
	public boolean apply(final Player perso, Player target, final int itemID, int cellid) {
		...
		case 5: {
			try {
				...
				if (count2 > 0) {
					...
					final org.cestra.object.Object O = T.createNewItem(count2, false);
		...
		case 18: {
			...
			final org.cestra.object.Object obj2 = World.getObjet(itemID);
		...
		case 33: {
			...
			final org.cestra.object.Object itemPos = perso.getObjetByPos(posItem);
			if (itemPos != null) {
				itemPos.clearStats();
		...
		case 50: {
			...
			final org.cestra.object.Object newObj = T2.createNewItem(20, false);
		...
		case 100: {
			...
			final org.cestra.object.Object newObjAdded = World.getObjTemplate(9201).createNewItem(1, false);
		...
		case 116: {
			final org.cestra.object.Object EPO = World.getObjet(itemID);
			if (EPO == null) {
				return true;
			}
			final org.cestra.object.Object pets = perso.getObjetByPos(8);
			if (pets == null) {
				return true;
			}
		...
		case 219: {
			...
			if (type3 == 1) {
				final org.cestra.object.Object newObjAdded2 = World.getObjTemplate(970).createNewItem(1, false);
			...
			if (type3 == 2) {
				final org.cestra.object.Object newObjAdded2 = World.getObjTemplate(969).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded2, true, -1)) {
					World.addObjet(newObjAdded2, true);
					perso.addObjet(newObjAdded2);
				}
			...
			if (type3 == 3) {
				final org.cestra.object.Object newObjAdded2 = World.getObjTemplate(971).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded2, true, -1)) {
					World.addObjet(newObjAdded2, true);
					perso.addObjet(newObjAdded2);
				}
		...
		case 220: {
			try {
				...
				if (perso.hasItemTemplate(obj3, qua0)) {
					...
					final org.cestra.object.Object newObjAdded3 = World.getObjTemplate(newObj2).createNewItem(newQua1,
							false);
					if (!perso.addObjetSimiler(newObjAdded3, true, -1)) {
						World.addObjet(newObjAdded3, true);
						perso.addObjet(newObjAdded3);
					}
					final org.cestra.object.Object newObjAdded4 = World.getObjTemplate(newObj3).createNewItem(newQua2,
							false);
		...
		case 221: {
			try {
				...
				if (perso.hasItemTemplate(obj3, qua0) && perso.hasItemTemplate(obj4, qua2)) {
					...
					final org.cestra.object.Object newObjAdded3 = World.getObjTemplate(newObj4).createNewItem(newQua3,
							false);
					if (!perso.addObjetSimiler(newObjAdded3, true, -1)) {
						World.addObjet(newObjAdded3, true);
						perso.addObjet(newObjAdded3);
		...
		case 223: {
			try {
				...
				if (perso.hasItemTemplate(obj5, qua3) && perso.hasItemTemplate(obj6, qua4)
					...
					final org.cestra.object.Object newObjAdded5 = World.getObjTemplate(newItem)
		...
		case 224: {
			try {
				...
				if (perso.hasItemTemplate(obj10, qua8) && perso.hasItemTemplate(obj11, qua9)
					...
					final org.cestra.object.Object newObjAdded6 = World.getObjTemplate(newItem2)
		...
		case 225: {
			try {
				...
				if (perso.hasItemTemplate(obj14, qua12) && perso.hasItemTemplate(obj15, qua13)
					...
					final org.cestra.object.Object newObjAdded7 = World.getObjTemplate(newItem3)
		...
		case 226: {
			if (perso.hasItemTemplate(1089, 1) && perso.hasEquiped(1021) && perso.hasEquiped(1019)
				...
				final org.cestra.object.Object newObj5 = World.getObjTemplate(1020).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObj5, true, -1)) {
					World.addObjet(newObj5, true);
					perso.addObjet(newObj5);
				}
				final org.cestra.object.Object newObj6 = World.getObjTemplate(1022).createNewItem(1, false);
		...
		case 231: {
			try {
				...
				if (perso.hasItemTemplate(obj17, qua15)) {
					...
					final org.cestra.object.Object newObjAdded8 = World.getObjTemplate(newItem4)
			...
			try {
				...
				if (pMap2 == 10131 || pMap2 == 10132 || pMap2 == 10133 || pMap2 == 10134 || pMap2 == 10135
					...
					if (count3 > 0) {
						...
						final org.cestra.object.Object O2 = T3.createNewItem(count3, false);
		...
		case 234: {
			...
			final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(IdObj).createNewItem(1, false);
		...
		case 235: {
			...
			if (perso.hasItemTemplate(757, 1) && perso.hasItemTemplate(368, 1) && perso.hasItemTemplate(369, 1)
				...
				final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(960).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded9, true, -1)) {
					World.addObjet(newObjAdded9, true);
					perso.addObjet(newObjAdded9);
				}
		...
		case 241: {
			if (perso.get_kamas() >= 10L && perso.getCurMap().getId() == 6863) {
				...
				final org.cestra.object.Object obj18 = OT.createNewItem(1, false);
		...
		case 450: {
			if (perso.getCurMap().getId() == 1844 && perso.get_kamas() >= 5000L && perso.hasItemTemplate(363, 5)) {
				...
				final org.cestra.object.Object newObjAdded8 = World.getObjTemplate(998).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded8, true, -1)) {
					World.addObjet(newObjAdded8, true);
					perso.addObjet(newObjAdded8);
				}
		...
		case 451: {
			if (perso.get_kamas() >= 200L && perso.getCurMap().getId() == 436) {
				...
				final org.cestra.object.Object newObjAdded8 = World.getObjTemplate(1004).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded8, true, -1)) {
					World.addObjet(newObjAdded8, true);
					perso.addObjet(newObjAdded8);
				}
		...
		case 452: {
			if (perso.hasItemTemplate(1000, 6) && perso.hasItemTemplate(1003, 1) && perso.hasItemTemplate(1018, 10)
				...
				final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(6716).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded9, true, -1)) {
					World.addObjet(newObjAdded9, true);
					perso.addObjet(newObjAdded9);
				}
		...
		case 455: {
			if (perso.hasItemTemplate(1006, 1) && perso.hasItemTemplate(1007, 1) && perso.hasItemTemplate(1008, 1)
				...
				final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(1086).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded9, true, -1)) {
					World.addObjet(newObjAdded9, true);
					perso.addObjet(newObjAdded9);
				}
		...
		case 456: {
			...
			final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(1088).createNewItem(1, false);
			if (!perso.addObjetSimiler(newObjAdded9, true, -1)) {
				World.addObjet(newObjAdded9, true);
				perso.addObjet(newObjAdded9);
			}
		...
		case 457: {
			if (perso.get_kamas() >= 1000L && perso.getCurMap().getId() == 1014) {
				...
				final org.cestra.object.Object newObjAdded10 = World.getObjTemplate(1089).createNewItem(1, false);
		...
		case 500: {
			...
			final org.cestra.object.Object newObjAdded9 = World.getObjTemplate(1728).createNewItem(1, false);
			if (!perso.addObjetSimiler(newObjAdded9, true, -1)) {
				World.addObjet(newObjAdded9, true);
				perso.addObjet(newObjAdded9);
			}
		...
		case 501: {
			...
			final org.cestra.object.Object newObjAdded11 = World.getObjTemplate(8000).createNewItem(1, false);
		...
		case 503: {
			...
			if (perso.hasItemTemplate(969, 1) && perso.hasItemTemplate(970, 1) && perso.hasItemTemplate(971, 1)) {
				...
				final org.cestra.object.Object newObjAdded12 = World.getObjTemplate(972).createNewItem(1, false);
		...
		case 504: {
			if (perso.getCurMap().getId() == 9717) {
				...
				if (type4 == 1) {
					final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(7890).createNewItem(1, false);
				...
				if (type4 == 2) {
					final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(7889).createNewItem(1, false);
					if (!perso.addObjetSimiler(newObjAdded13, true, -1)) {
						World.addObjet(newObjAdded13, true);
						perso.addObjet(newObjAdded13);
					}
				...
				if (type4 == 3) {
					final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(7888).createNewItem(1, false);
					if (!perso.addObjetSimiler(newObjAdded13, true, -1)) {
						World.addObjet(newObjAdded13, true);
						perso.addObjet(newObjAdded13);
					}
				...
				if (type4 == 4) {
					final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(7887).createNewItem(1, false);
					if (!perso.addObjetSimiler(newObjAdded13, true, -1)) {
						World.addObjet(newObjAdded13, true);
						perso.addObjet(newObjAdded13);
					}
		...
		case 508: {
			if (perso.getCurMap().getId() == 8317) {
				...
				final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(7415).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded13, true, -1)) {
					World.addObjet(newObjAdded13, true);
					perso.addObjet(newObjAdded13);
				}
		...
		case 509: {
			...
			final org.cestra.object.Object newObjAdded13 = World.getObjTemplate(6885).createNewItem(1, false);
			if (!perso.addObjetSimiler(newObjAdded13, true, -1)) {
				World.addObjet(newObjAdded13, true);
				perso.addObjet(newObjAdded13);
			}
			SocketManager.GAME_SEND_Im_PACKET(perso, "021;1~6885");
			final org.cestra.object.Object newObjAdded14 = World.getObjTemplate(8388).createNewItem(1, false);
		...
		case 510: {
			if (perso.getCurMap().getId() == 3373 && perso.hasItemTemplate(6885, 1)) {
				...
				final org.cestra.object.Object newObjAdded15 = World.getObjTemplate(6887).createNewItem(1, false);
		...
		case 511: {
			...
			final org.cestra.object.Object newObjAdded16 = World.getObjTemplate(cadeau).createNewItem(1, false);
		...
		case 512: {
			if (perso.getCurMap().getId() == 10213) {
				...
				final org.cestra.object.Object newObjAdded17 = World.getObjTemplate(8476).createNewItem(1, false);
		...
		case 513: {
			if (perso.getCurMap().getId() == 10199) {
				...
				final org.cestra.object.Object newObjAdded17 = World.getObjTemplate(8477).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded17, true, -1)) {
					World.addObjet(newObjAdded17, true);
					perso.addObjet(newObjAdded17);
				}
		...
		case 515: {
			if (perso.getCurMap().getId() == 8497) {
				...
				final org.cestra.object.Object newObjAdded17 = World.getObjTemplate(7414).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded17, true, -1)) {
					World.addObjet(newObjAdded17, true);
					perso.addObjet(newObjAdded17);
				}
		...
		case 516: {
			if (perso.getCurMap().getId() == 1140 && perso.get_kamas() >= 1000L) {
				final org.cestra.object.Object newObjAdded17 = World.getObjTemplate(2239).createNewItem(1, false);
				if (!perso.addObjetSimiler(newObjAdded17, true, -1)) {
					World.addObjet(newObjAdded17, true);
					perso.addObjet(newObjAdded17);
				}
		...
		case 519: {
			...
			org.cestra.object.Object obj19 = World.getObjTemplate(Integer.parseInt(this.args.split(";")[2]))
		...
		case 520: {
			...
			org.cestra.object.Object obj19 = World.getObjTemplate(7414).createNewItem(1, false);
		...
		case 521: {
			...
			if (perso.hasItemTemplate(7887, 1) && perso.hasItemTemplate(7888, 1) && perso.hasItemTemplate(7889, 1)
				...
				final org.cestra.object.Object obj19 = World.getObjTemplate(8073).createNewItem(1, false);
				if (perso.addObjet(obj19, true)) {
					World.addObjet(obj19, true);
				}
		...
		case 522: {
			...
			final org.cestra.object.Object obj19 = World.getObjTemplate(6978).createNewItem(1, false);
			if (perso.addObjet(obj19, true)) {
				World.addObjet(obj19, true);
			}
		...
		case 526: {
			...
			final org.cestra.object.Object obj19 = World.getObjTemplate(7703).createNewItem(1, false);
			if (perso.addObjet(obj19, true)) {
				World.addObjet(obj19, true);
			}
		...
		case 964: {
			...
			final org.cestra.object.Object obj20 = t2.createNewItem(1, false);
		...
		case 965: {
			...
			if (perso.hasItemTemplate(9811, 1)) {
				...
				final org.cestra.object.Object obj21 = t3.createNewItem(1, false);
		...
		case 973: {
			...
			final org.cestra.object.Object obj22 = dofus.createNewItem(1, false);
		...
		case 985: {
			try {
				...
				if (perso.hasItemTemplate(item, 1)) {
					...
					SocketManager.GAME_SEND_Im_PACKET(perso, "022;1~" + item);
					perso.removeByTemplateID(item, 1);
					final org.cestra.object.Object obj22 = t4.createNewItem(1, false);
		...
		case 987: {
			try {
				...
				final org.cestra.object.Object obj22 = t5.createNewItem(1, false);
				if (perso.addObjet(obj22, false)) {
					SocketManager.GAME_SEND_Im_PACKET(perso, "021;1~" + obj22.getTemplate().getId());
					World.addObjet(obj22, true);
					Database.getStatique().getPlayerData().update(perso, true);
