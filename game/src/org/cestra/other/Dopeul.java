...
public class Dopeul {
	...
	public static void getReward(final Player perso, final int type) {
		final org.cestra.map.Map curMap = perso.getCurMap();
		...
		case 2: {
			...
			final org.cestra.object.Object obj = World.getObjTemplate(10207).createNewItem(1, true);
		...
		case 4: {
			...
			final org.cestra.object.Object obj2 = OT.createNewItem(1, false);
		...
		case 5: {
			...
			final org.cestra.object.Object obj = World.getObjTemplate(1575).createNewItem(1, true);
			if (perso.addObjet(obj, false)) {
				World.addObjet(obj, true);
			}
