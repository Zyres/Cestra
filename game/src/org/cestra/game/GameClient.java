...
import org.cestra.command.Admin;
import org.cestra.command.Command;
import org.cestra.command.CommandPlayer;
import org.cestra.command.server.Groupes;
import org.cestra.common.ConditionParser;
import org.cestra.common.CryptManager;
import org.cestra.common.Formulas;
import org.cestra.common.Pathfinding;
import org.cestra.common.SocketManager;
import org.cestra.db.Database;
import org.cestra.dynamic.Migration;
...
import org.cestra.entity.exchange.CraftSecure;
...
import org.cestra.other.Action;
...
public class GameClient {
	...
	public void goToMap(final String packet) {
		...
		final ArrayList<org.cestra.map.Map> i = World.getMapByPosInArrayPlayer(MapX, MapY, this.perso);
		org.cestra.map.Map map = null;
		if (i.size() <= 0) {
			return;
		}
		if (i.size() > 1) {
					...
					for (final Action a : World.getNpcAnswer(Integer.parseInt(quest.getAnwsers())).getActions()) {
						if (a.getId() == 15 && this.perso.hasItemTemplate(10207, 1)) {
							...
							for (int length = (split = this.perso.getItemTemplate(10207).getTxtStat().get(814)
								...
								final org.cestra.map.Map map = this.perso.getCurMap();
								if (map != null) {
	...
	private void buy(final String packet) {
		...
		if (perso.boutique) {
			try {
				...
				org.cestra.object.Object newObj = null;
		...
		if (this.perso.get_isTradingWith() > 0) {
			...
			if (seller != null && seller != this.perso) {
				...
				synchronized (seller.getStoreItems()) {
					...
					final org.cestra.object.Object itemStore = World.getObjet(itemID);
					if (itemStore == null) {
						// monitorexit(seller.getStoreItems())
						return;
					}
					...
					if (qua == itemStore.getQuantity()) {
						...
						final org.cestra.object.Object clone = org.cestra.object.Object.getCloneObjet(itemStore, qua);
		...
		try {
			...
			if (template.getPoints() > 0) {
				...
				final org.cestra.object.Object newObj = template.createNewItem(qua2, true);
				...
				final org.cestra.object.Object newObj2 = template.createNewItem(qua2, false);
	...
	private void ready() {
		...
		if (this.perso.getConcasseur() != null) {
			...
			for (final World.Couple<Integer, Integer> couple : this.perso.getConcasseur().getObjects()) {
				final org.cestra.object.Object object = World.getObjet(couple.first);
				if (object != null) {
					if (couple.second < 1) {
						continue;
					}
	...
	private synchronized void movementItemOrKamas(final String packet) {
		...
		if (this.perso.get_isOnCollectorID() != 0) {
			...
			case 'O': {
				...
				final org.cestra.object.Object obj = World.getObjet(guid2);
				if (obj == null) {
					return;
				}
				...
				if (packet.charAt(2) == 'O') {
					if (packet.charAt(3) == '+') {
						...
						try {
							...
							final org.cestra.object.Object object = World.getObjet(id);
							if (object == null) {
								return;
							}
							if (qua < 1) {
				...
				if (this.perso.getCurNpcExchange() != null) {
						...
						if (packet.charAt(3) == '+') {
							...
							try {
								...
								if (obj.getQuantity() > qua) {
									...
									final org.cestra.object.Object newObj = T.createNewItem(qua, false);
									World.addObjet(newObj, true);
					...
					if (this.perso.get_isTradingWith() < 0 && this.perso.getConcasseur() == null) {
						...
						case '+': {
							...
							SocketManager.GAME_SEND_STATS_PACKET(this.perso);
							org.cestra.object.Object obj3 = World.getObjet(itmID);
							...
							if (newQua <= 0) {
								...
								final org.cestra.object.Object newObj2 = org.cestra.object.Object.getCloneObjet(obj3,
										rAmount);
								World.addObjet(newObj2, true);
								obj3 = newObj2;
	...
	private synchronized void putInInventory(String packet) {
		if (this.perso.getInMountPark() != null) {
			...
			case 'c': {
				...
				final org.cestra.object.Object obj2 = OM.createNewItem(1, false);
	...
	private void request(final String packet) {
		if (packet.substring(2, 4).equals("13")) {
			try {
				...
				final org.cestra.object.Object object = player.getObjetByPos(1);
				if (object == null) {
					this.perso.send("BN");
					return;
				}
		...
		if (packet.substring(2, 4).equals("12")) {
			try {
				...
				final org.cestra.object.Object object = this.perso.getObjetByPos(1);
				if (object == null) {
					return;
				}
				boolean ok = false;
	...
	private void leaveExchange() {
		...
		if (this.perso.get_isOnCollectorID() != 0) {
			...
			for (final Player z : World.getGuild(Collector.getGuildId()).getMembers()) {
				...
				SocketManager.GAME_SEND_gITM_PACKET(z, org.cestra.entity.Collector.parseToGuild(z.get_guild().getId()));
				String str = "";
	...
	private void dropObject(final String packet) {
		...
		if (qua >= obj.getQuantity()) {
			...
			obj.setQuantity(obj.getQuantity() - qua);
			final org.cestra.object.Object obj2 = org.cestra.object.Object.getCloneObjet(obj, qua);
			obj2.setPosition(-1);
	...
	private synchronized void movementObject(final String packet) {
		...
		try {
			...
			if (pos == 8 && obj.getTemplate().getType() != 18 && this.perso.getObjetByPos(pos) != null) {
				final org.cestra.object.Object pets = this.perso.getObjetByPos(pos);
				...
				final org.cestra.object.Object exObj = this.perso.getObjetByPos2(pos);
				...
				if (obj.getTemplate().getType() == 113) {
					...
					if (obj.getQuantity() > 1) {
						...
						if (obj.getQuantity() - qua > 0) {
							...
							final org.cestra.object.Object newItem = org.cestra.object.Object.getCloneObjet(obj,
									newItemQua);
					...
					if (exObj != null) {
						...
						final org.cestra.object.Object obj2;
	...
	private void dissociateObvi(final String packet) {
		...
		final org.cestra.object.Object obV = t.createNewItem(1, true);
	...
	private void feedObvi(final String packet) {
		...
		final org.cestra.object.Object obj = World.getObjet(guid);
		final org.cestra.object.Object objVictime = World.getObjet(victime);
	...
	private void removeObjectInMountPark(final String packet) {
		...
		final org.cestra.object.Object obj = t.createNewItem(1, false);
		int statNew = 0;
