...
public class PetEntry {
	...
	public int getCurrentStatsPoids() {
		final org.cestra.object.Object obj = World.getObjet(this.objectId);
		if (obj == null) {
			return 0;
		}
		int cumul = 0;
	...
	public void setMax(Player p,org.cestra.object.Object obj) {
	...
	public void eat(final Player p, final int min, final int max, final int statsID,
			final org.cestra.object.Object feed) {
		final org.cestra.object.Object obj = World.getObjet(this.objectId);
		if (obj == null) {
			return;
		}
