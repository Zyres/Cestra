package org.cestra.entity.monster;
...
import org.cestra.entity.monster.boss.MaitreCorbac;
...
public class Monster {
	...
	public static class MobGroup {
		...
		public MobGroup(final int Aid, final int Aalign, final ArrayList<MobGrade> possibles,
				final org.cestra.map.Map Map, final int cell, final int fixSize, final int minSize, final int maxSize,
