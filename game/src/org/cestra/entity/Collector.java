...
public class Collector {
	...
	private Map<Integer, org.cestra.object.Object> logObjects;
	private Map<Integer, org.cestra.object.Object> objects;
	...
	public Collector(final int id, final short map, final int cell, final byte orientation, final int aGuildID,
		...
		this.logObjects = new TreeMap<Integer, org.cestra.object.Object>();
		this.objects = new TreeMap<Integer, org.cestra.object.Object>();
		...
		for (int length = (split = items.split("\\|")).length, i = 0; i < length; ++i) {
			...
			if (!item.equals("")) {
				...
				final org.cestra.object.Object obj = World.getObjet(itemId);
				if (obj != null) {
	...
	public void addLogObjects(final int id, final org.cestra.object.Object obj) {
	...
	public String getLogObjects() {
		...
		for (final org.cestra.object.Object obj : this.logObjects.values()) {
			str.append(";").append(obj.getTemplate().getId()).append(",").append(obj.getQuantity());
		}
		return str.toString();
	}

	public Map<Integer, org.cestra.object.Object> getOjects() {
		return this.objects;
	}
	...
	public int getPodsTotal() {
		int pod = 0;
		for (final org.cestra.object.Object object : this.objects.values()) {
			if (object != null) {
	...
	public boolean addObjet(final org.cestra.object.Object newObj) {
		for (final Map.Entry<Integer, org.cestra.object.Object> entry : this.objects.entrySet()) {
	...
	public static String parseGM(final org.cestra.map.Map map) {
	...
	public static String parseToGuild(final int GuildID) {
		...
		for (final Map.Entry<Integer, Collector> Collector : World.getCollectors().entrySet()) {
			if (Collector.getValue().getGuildId() == GuildID) {
				final org.cestra.map.Map map = World.getMap(Collector.getValue().getMap());
				if (isFirst) {
					packet.append("+");
				}
				if (!isFirst) {
	...
	public void delCollector(final int id) {
		for (final org.cestra.object.Object obj : this.objects.values()) {
	...
	public void removeFromCollector(final Player P, final int id, final int qua) {
		...
		final org.cestra.object.Object CollectorObj = World.getObjet(id);
		org.cestra.object.Object PersoObj = P.getSimilarItem(CollectorObj);
		...
		if (PersoObj == null) {
			if (newQua <= 0) {
				...
				PersoObj = org.cestra.object.Object.getCloneObjet(CollectorObj, qua);
	...
	public Collection<org.cestra.object.Object> getDrops() {
