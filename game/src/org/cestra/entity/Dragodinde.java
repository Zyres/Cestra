...
public class Dragodinde {
	...
	public Dragodinde(final int id, final int color, final int sexe, final int amor, final int resistencia,
		...
		for (int length2 = (split2 = items.split(";")).length, j = 0; j < length2; ++j) {
			...
			if (!str.equalsIgnoreCase("")) {
				try {
					final org.cestra.object.Object obj = World.getObjet(Integer.parseInt(str));
	...
	public void aumMaduturite(final int Resist) {
		...
		if (this._maturite < maxMadurez) {
			...
			if (this._size < 100) {
				final org.cestra.map.Map map = World.getMap(this._mapId);
	...
	public synchronized void moveMounts(final Player perso, final int cellules, final boolean remove) {
		...
		String path = "";
		final org.cestra.map.Map map = perso.getCurMap();
		...
		while (i < cellules) {
			...
			if (MP.getCellAndObject().containsKey(cellTest) && this._fatigue < 240) {
				...
				if (item == 7755 || item == 7756 || item == 7757 || item == 7758 || item == 7759 || item == 7760
						...
						|| item == 7629) {
					this.resSerenite(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
					...
					this.aumFatige();
						...
						|| item == 7798) {
					if (this._serenite < 0) {
						this.aumResistence(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					}
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
					...
					this.aumFatige();
						...
						|| item == 7690) {
					this.resFatige();
					this.aumEnergie(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
						this.SereniteFemelle();
						...
						|| item == 7699 || item == 7700) {
					if (this._serenite > 0) {
						this.aumAmour(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					}
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
					...
					this.aumFatige();
						...
						|| item == 7746) {
					this.aumSerenite(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
						this.SereniteFemelle();
					...
					if (this._serenite <= 2000 && this._serenite >= -2000) {
						this.aumMaduturite(org.cestra.map.Map.getObjResist(perso, cellTest, item));
					}
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
		...
		while (i < cellules) {
			...
			if (MP.getCellAndObject().containsKey(cellTest) && this._fatigue < 240) {
				...
				if (item == 7755 || item == 7756 || item == 7757 || item == 7758 || item == 7759 || item == 7760
						...
						|| item == 7773 || item == 7774 || item == 7625 || item == 7626 || item == 7627
						|| item == 7629) {
					this.resSerenite(org.cestra.map.Map.getObjResist(MP, cellTest, item));
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
						this.SereniteFemelle();
				...
				if (item == 7775 || item == 7776 || item == 7777 || item == 7778 || item == 7779 || item == 7780
						...
						|| item == 7798) {
					if (this._serenite < 0) {
						this.aumResistence(org.cestra.map.Map.getObjResist(MP, cellTest, item));
					}
					if (this._sexe == 0) {
						this.SereniteMale();
					} else {
				...
				if (item == 7606 || item == 7607 || item == 7608 || item == 7609 || item == 7610 || item == 7611
						...
						|| item == 7690) {
					this.resFatige();
					this.aumEnergie(org.cestra.map.Map.getObjResist(MP, cellTest, item));
					if (this._sexe == 0) {
						this.SereniteMale();
						break;
					}
					...
					if (item == 7634 || item == 7635 || item == 7636 || item == 7637 || item == 7691 || item == 7692
						...
						if (this._serenite > 0) {
							this.aumAmour(org.cestra.map.Map.getObjResist(MP, cellTest, item));
						}
						if (this._sexe == 0) {
							this.SereniteMale();
						} else {
					...
					if (item == 7628 || item == 7622 || item == 7623 || item == 7624 || item == 7733 || item == 7734
							...
							|| item == 7745 || item == 7746) {
						this.aumSerenite(org.cestra.map.Map.getObjResist(MP, cellTest, item));
						if (this._sexe == 0) {
							this.SereniteMale();
						} else {
							this.SereniteFemelle();
					...
					if (item == 7590 || item == 7591 || item == 7592 || item == 7593 || item == 7594 || item == 7595
						...
						if (this._serenite <= 2000 && this._serenite >= -2000) {
							this.aumMaduturite(org.cestra.map.Map.getObjResist(MP, cellTest, item));
						}
						if (this._sexe == 0) {
							this.SereniteMale();
						} else {
	...
	public int get_podsActuels() {
		int pods = 0;
		synchronized (this._items) {
			for (final org.cestra.object.Object value : this._items.values()) {
	...
	public void addInDinde(final int guid, final int qua, final Player P) {
		...
		org.cestra.object.Object TrunkObj = this.getSimilarDindeItem(PersoObj);
		...
		if (TrunkObj == null) {
			if (newQua <= 0) {
				...
				TrunkObj = org.cestra.object.Object.getCloneObjet(PersoObj, qua);
	...
	public void removeFromDinde(final int guid, final int qua, final Player P) {
		...
		final org.cestra.object.Object TrunkObj = World.getObjet(guid);
		synchronized (this._items) {
		...
		// monitorexit(this._items)
		org.cestra.object.Object PersoObj = P.getSimilarItem(TrunkObj);
		String str = "";
		...
		if (PersoObj == null) {
			if (newQua <= 0) {
				...
				PersoObj = org.cestra.object.Object.getCloneObjet(TrunkObj, qua);
	...
	private org.cestra.object.Object getSimilarDindeItem(final org.cestra.object.Object obj) {
		synchronized (this._items) {
			for (final org.cestra.object.Object value : this._items.values()) {
