...
public class Constant {
	...
	public static final String SERVER_MAKER = "Cestra";
	...
	public static int getNearCellidUnused(final Player _perso) {
		...
		int cell = 0;
		int calcul = 0;
		final org.cestra.map.Map map = _perso.getCurMap();
		if (map == null) {
			return -1;
		}
	...
	public static boolean isTaverne(final org.cestra.map.Map map) {
		switch (map.getId()) {
		case 7573: {
			return true;
		}
