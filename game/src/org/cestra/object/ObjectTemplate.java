...
public class ObjectTemplate {
	...
	public org.cestra.object.Object createNewCertificat(final org.cestra.object.Object obj) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		if (this.getType() == 77) {
			...
			item = new org.cestra.object.Object(id, this.getId(), 1, -1, obj.getStats(), new ArrayList<SpellEffect>(),
	...
	public org.cestra.object.Object createNewFamilier(final org.cestra.object.Object obj) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
	...
	public org.cestra.object.Object createNewBenediction(final int turn) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		final Stats stats = this.generateNewStatsFromTemplate(this.getStrTemplate(), true);
		stats.addOneStat(811, turn);
		item = new org.cestra.object.Object(id, this.getId(), 1, 23, stats, new ArrayList<SpellEffect>(),
				new TreeMap<Integer, Integer>(), new TreeMap<Integer, String>(), 0);
		return item;
	}

	public org.cestra.object.Object createNewMalediction() {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		final Stats stats = this.generateNewStatsFromTemplate(this.getStrTemplate(), true);
		stats.addOneStat(811, 1);
		item = new org.cestra.object.Object(id, this.getId(), 1, 22, stats, new ArrayList<SpellEffect>(),
				new TreeMap<Integer, Integer>(), new TreeMap<Integer, String>(), 0);
		return item;
	}

	public org.cestra.object.Object createNewRoleplayBuff() {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		final Stats stats = this.generateNewStatsFromTemplate(this.getStrTemplate(), true);
		stats.addOneStat(811, 1);
		item = new org.cestra.object.Object(id, this.getId(), 1, 21, stats, new ArrayList<SpellEffect>(),
				new TreeMap<Integer, Integer>(), new TreeMap<Integer, String>(), 0);
		return item;
	}

	public org.cestra.object.Object createNewCandy(final int turn) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		final Stats stats = this.generateNewStatsFromTemplate(this.getStrTemplate(), true);
		stats.addOneStat(811, turn);
		item = new org.cestra.object.Object(id, this.getId(), 1, 25, stats, new ArrayList<SpellEffect>(),
				new TreeMap<Integer, Integer>(), new TreeMap<Integer, String>(), 0);
		return item;
	}

	public org.cestra.object.Object createNewFollowPnj(final int turn) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item = null;
		final Stats stats = this.generateNewStatsFromTemplate(this.getStrTemplate(), true);
		stats.addOneStat(811, turn);
		stats.addOneStat(148, 0);
		item = new org.cestra.object.Object(id, this.getId(), 1, 24, stats, new ArrayList<SpellEffect>(),
				new TreeMap<Integer, Integer>(), new TreeMap<Integer, String>(), 0);
		return item;
	}

	public org.cestra.object.Object createNewItem(final int qua, final boolean useMax) {
		final int id = World.getNewItemGuid();
		org.cestra.object.Object item;
		if (this.getType() == 24 && (Constant.isCertificatDopeuls(this.getId()) || this.getId() == 6653)) {
			...
			item = new org.cestra.object.Object(id, this.getId(), qua, -1, new Stats(false, null),
			...
			Stats.put(1000, 0);
			Stats.put(962, 1);
			item = new org.cestra.object.Object(id, this.getId(), qua, -1,
