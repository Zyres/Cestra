...
import org.cestra.dynamic.Noel;
...
public class ObjectAction {
	...
	public void apply(final Player player0, final Player target, final int objet, final int cellid) {
		...
		try {
			...
			for (int length = (split = this.type.split("\\;")).length, n = 0; n < length; ++n) {
				...
				case 10: {
					final org.cestra.object.Object obj = World.getObjet(objet);
					if (obj == null) {
						return;
					}
					final org.cestra.object.Object pets = player.getObjetByPos(8);
					if (pets == null) {
						return;
					}
				...
				case 26: {
					...
					for (int length4 = (split4 = arg.split(";")).length, n4 = 0; n4 < length4; ++n4) {
						...
						final org.cestra.object.Object obj = World.getObjTemplate(Integer.parseInt(l.split(",")[0]))
	...
	private boolean haveEffect(final int id, final org.cestra.object.Object object, final Player player) {
		switch (id) {
		case 8378: {
			for (final World.Couple<Integer, Integer> couple : ((Fragment) object).getRunes()) {
				...
				final org.cestra.object.Object newObject = objectTemplate.createNewItem(couple.second, true);
				if (newObject == null) {
					continue;
				}
