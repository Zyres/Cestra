...
import org.cestra.dynamic.FormuleOfficiel;
...
import org.cestra.entity.monster.boss.Bandit;
import org.cestra.fight.ia.IAThread;
import org.cestra.fight.spells.LaunchedSpell;
import org.cestra.fight.spells.Spell;
import org.cestra.fight.spells.SpellEffect;
import org.cestra.fight.traps.Glyph;
import org.cestra.fight.traps.Trap;
import org.cestra.fight.turn.Turn;
...
public class Fight {
	...
	private Prism prism;
	private org.cestra.map.Map map;
	private org.cestra.map.Map mapOld;
	...
	public org.cestra.map.Map getMap() {
		return this.map;
	}

	public void setMap(final org.cestra.map.Map map) {
		this.map = map;
	}

	public org.cestra.map.Map getMapOld() {
		return this.mapOld;
	}

	public void setMapOld(final org.cestra.map.Map mapOld) {
		this.mapOld = mapOld;
	}
	...
	public static int getFightIdByFighter(final org.cestra.map.Map map, final int guid) {
	...
	public Fight(final int type, final int id, final org.cestra.map.Map map, final Player perso, final Player init2) {
		this.state = 0;
		this.guildId = -1;
		this.type = -1;
		this.captWinner = -1;
	...
	public Fight(final int id, final org.cestra.map.Map map, final Player perso, final Monster.MobGroup group) {
	...
	public Fight(final int id, final org.cestra.map.Map map, final Player perso, final Collector perco) {
		this.state = 0;
		this.guildId = -1;
		this.type = -1;
		this.captWinner = -1;
	...
	public Fight(final int id, final org.cestra.map.Map Map, final Player perso, final Prism Prisme) {
		this.state = 0;
		this.guildId = -1;
		this.type = -1;
		this.captWinner = -1;
				...
				if (this.getState() == 2) {
					...
					if (isValid1) {
								...
								if (F.getPersonnage().getId() != f.getPersonnage().getId()) {
									...
									if (this.getType() == 1 || this.getType() == 4 || this.getType() == 5
										...
										if (F.getPersonnage().getObjetByPos(8) != null) {
											final org.cestra.object.Object obj = F.getPersonnage().getObjetByPos(8);
											if (obj != null) {
						...
						if (this.getType() == 1 || this.getType() == 4 || this.getType() == 5 || this.getType() == 2
							...
							if (F.getPersonnage().getObjetByPos(8) != null) {
								final org.cestra.object.Object obj2 = F.getPersonnage().getObjetByPos(8);
								if (obj2 != null) {
	...
	public void tryCaC(final Player perso, final int cellID) {
		...
		if (perso.getObjetByPos(1) == null) {
			...
			final org.cestra.object.Object arme = perso.getObjetByPos(1);
	...
	public static void FightStateAddFlag(final org.cestra.map.Map map, final Player P) {
		for (final Map.Entry<Integer, Fight> fight : map.getFights().entrySet()) {
	...
	public void onPlayerWin(final Fighter fighter, final ArrayList<Fighter> looseTeam) {
		...
		final org.cestra.object.Object arme = player.getObjetByPos(1);
		...
		if (this.getType() == 4) {
			final org.cestra.object.Object obj = player.getObjetByPos(8);
			if (obj != null) {
	...
	public String getGE(final int win) {
		try {
			...
			Collection<org.cestra.object.Object> collectorDrops = null;
			...
			for (final Fighter k : TEAM1) {
				...
				if (this.getType() == 5 || this.getType() == 4 || this.getType() == 0 || this.getType() == 3) {
					...
					if (this.getType() == 5 && win == 1) {
						...
						int l = 0;
						final ArrayList<org.cestra.object.Object> temp = new ArrayList<org.cestra.object.Object>();
						temp.addAll(collectorDrops);
						Collections.shuffle(temp);
						for (final org.cestra.object.Object object : temp) {
					...
					if (k.getPersonnage() != null || (k.getMob() != null && k.getMob().getTemplate().getId() == 285)) {
						...
						for (final Map.Entry<Integer, Integer> entry2 : itemWon.entrySet()) {
							...
							if (OT3.getType() == 32 && k.getPersonnage() != null) {
								...
								final org.cestra.object.Object obj = OT3.createNewItem(entry2.getValue(), false);
						...
						if (this.getType() == 3) {
							for (final Fighter F8 : TEAM2) {
								...
								if (m2 == null) {
									...
									final org.cestra.object.Object obj2 = OT4.createNewItem(1, false);
						...
						if (this.getType() == 4 && k.getPersonnage() != null) {
							...
							case 8984: {
								final org.cestra.object.Object obj = World.getObjTemplate(8012).createNewItem(1, false);
						...
						if (winxp != 0L && k.getPersonnage() != null) {
							if (k.getPersonnage().getMorphMode()) {
								final org.cestra.object.Object obj3 = k.getPersonnage().getObjetByPos(1);
			...
			if (Collector.getCollectorByMapId(this.getMap().getId()) != null && this.getType() == 4) {
				...
				if (p6.getPodsTotal() < p6.getMaxPod()) {
					...
					for (final Map.Entry<Integer, Integer> entry4 : itemWon3.entrySet()) {
						...
						final org.cestra.object.Object obj4 = OT6.createNewItem(entry4.getValue(), false);
						if (!p6.addObjet(obj4)) {
							continue;
						}
