package org.cestra.command.server;
...
import org.cestra.game.scheduler.WorldSave;
				...
				if (command.equalsIgnoreCase("NAMEGO") || command.equalsIgnoreCase("NGO")) {
					...
					if (command.equalsIgnoreCase("MUTE")) {
						...
						synchronized (perso.getItems()) {
							for (final Map.Entry<Integer, org.cestra.object.Object> entry6 : perso.getItems()
									.entrySet()) {
						...
						SocketManager.GAME_SEND_CONSOLE_MESSAGE_PACKET(this.getClient(), mess5);
						for (final Map.Entry<Integer, org.cestra.object.Object> entry6 : cBank.getBank().entrySet()) {
						...
						synchronized (perso.getStoreItems()) {
							for (final Map.Entry<Integer, Integer> obj : perso.getStoreItems().entrySet()) {
								final org.cestra.object.Object entry7 = World.getObjet(obj.getKey());
						...
						synchronized (perso.getMount().getItems()) {
							for (final Map.Entry<Integer, org.cestra.object.Object> entry6 : perso.getMount().getItems()
									.entrySet()) {
								mess4 = String.valueOf(entry6.getValue().getGuid()) + " || "
										+ entry6.getValue().getTemplate().getName() + " || "
										+ entry6.getValue().getQuantity();
						...
						if (command.equalsIgnoreCase("ERASEALLMAP")) {
							for (final org.cestra.map.Map map : World.getAllMaps()) {
								map.delAllDropItem();
							}
							SocketManager.GAME_SEND_CONSOLE_MESSAGE_PACKET(this.getClient(),
						...
						if (command.equalsIgnoreCase("MORPH")) {
							...
							if (command.equalsIgnoreCase("ADDHONOR")) {
								...
								if (command.equalsIgnoreCase("LISTMAP")) {
									String data = "";
									final ArrayList<org.cestra.map.Map> m = World.getMapByPosInArray(
											this.getPlayer().getCurMap().getX(), this.getPlayer().getCurMap().getY());
									for (final org.cestra.map.Map map2 : m) {
								...
								if (command.equalsIgnoreCase("DELINVENTORY")) {
									...
									synchronized (perso.getItems()) {
										...
										for (final org.cestra.object.Object obj2 : list) {
											...
											if (command.equalsIgnoreCase("APTRIGGER")) {
												...
												if (command.equalsIgnoreCase("STARTFIGHT")) {
													...
													if (command.equalsIgnoreCase("MAPINFO")) {
														...
														SocketManager.GAME_SEND_CONSOLE_MESSAGE_PACKET(this.getClient(),
																mess);
														final org.cestra.map.Map map3 = this.getPlayer().getCurMap();
													...
													if (command.equalsIgnoreCase("UNBANIP")) {
														...
														if (command.equalsIgnoreCase("KAMAS")) {
															...
															for (final ObjectTemplate t : IS.getItemTemplates()) {
																final org.cestra.object.Object obj3 = t.createNewItem(1,
																		useMax);
															...
															final org.cestra.object.Object obj2 = t.createNewItem(qua,
																	useMax);
																...
																if (command.equalsIgnoreCase("RES")) {
																	...
																	if (command.equalsIgnoreCase("RESET")) {
																		...
																		if (command.equalsIgnoreCase("GIFTS")) {
																			...
																			final org.cestra.object.Object object = World
																					.getObjet(obj4);
																			if (object == null) {
																				SocketManager
																						.GAME_SEND_CONSOLE_MESSAGE_PACKET(
																			...
																			if (command.equalsIgnoreCase("O")) {
																				...
																				if (command.equalsIgnoreCase(
																					...
																					final org.cestra.map.Map map2 = this
																							.getPlayer().getCurMap();
																					final Npc npc2 = map2
																							.getNpc(npcGUID);
																					...
																					if (command.equalsIgnoreCase(
																						...
																						for (final Map.Entry<Integer, org.cestra.map.Map> i2 : World
																								...
																								if (command
																									...
																									for (final ObjectTemplate obj5 : World
																										...
																										if (obj5.getType() == type) {
																											final org.cestra.object.Object addObj = obj5
																													.createNewItem(
																															1,
																															true);
																											if (!this
																								...
																								if (command
																									...
																									if (command
																										...
																										if (command
																											...
																											for (final Quest_Etape e3 : q2
																												...
																												for (final Map.Entry<Integer, Integer> entry12 : e3
																													...
																													final int qua2 = entry12
																															.getValue();
																													final org.cestra.object.Object obj6 = objT
																															.createNewItem(
																																	qua2,
																																	false);
																													if (this.getPlayer()
																											...
																											final Player perso = this
																													.getPlayer();
																											final org.cestra.map.Map map3 = perso
																													.getCurMap();
																			...
																			if (command.equalsIgnoreCase("RSF")) {
																				...
																				final Map<Short, org.cestra.map.Map> Maps = World
																						.getMaps();
																				for (final Map.Entry<Short, org.cestra.map.Map> entry13 : Maps
																						.entrySet()) {
																					final org.cestra.map.Map map4 = entry13
																							.getValue();
																					if (map4.getPlaces()
																							.equalsIgnoreCase(
																									sf2.getPlacesStr())
																				...
																				final org.cestra.map.Map map5 = perso2
																						.getCurMap();
																				...
																				if (command
																						...
																						&& (Config.config == 1
																								|| Config.config == 5)) {
																					final Map<Short, org.cestra.map.Map> Maps2 = World
																							.getMaps();
																					int i = 0;
																					ArrayList<Case> case3 = null;
																					ArrayList<Case> case4 = null;
																					String mess3 = "";
																					for (final Map.Entry<Short, org.cestra.map.Map> entry15 : Maps2
																							.entrySet()) {
																						final org.cestra.map.Map map6 = entry15
																								.getValue();
																						if ((map6.getPlaces()
																								.endsWith("|")
																								|| map6.getPlaces()
																				...
																				if (command.equalsIgnoreCase(
																					...
																					for (final Map.Entry<Short, org.cestra.map.Map> entry16 : Maps2
																							.entrySet()) {
																						final org.cestra.map.Map map7 = entry16
																								.getValue();
																						if (map7.getW() == 15
																								&& map7.getH() == 17
																								&& !map7.getMobGroups()
																					...
																					if (infos.length > 1) {
																						...
																						final Player perso3 = this
																								.getPlayer();
																						final org.cestra.map.Map map8 = perso3
																								.getCurMap();
																						final World.SubArea subArea = map8
																								.getSubArea();
																						final ArrayList<org.cestra.map.Map> maps = subArea
																								.getMaps();
																						int i4 = 0;
																						int y2 = 0;
																						for (final org.cestra.map.Map m2 : maps) {
																							if (m2.getPlaces()
																									.equalsIgnoreCase(
																											"")
																									|| m2.getPlaces()
																					...
																					if (infos.length > 4) {
																						...
																						final Player perso6 = this
																								.getPlayer();
																						final org.cestra.map.Map map6 = perso6
																								.getCurMap();
																						final World.SubArea subArea2 = map6
																								.getSubArea();
																						final ArrayList<org.cestra.map.Map> maps2 = subArea2
																								.getMaps();
																						int i5 = 0;
																						int y3 = 0;
																						for (final org.cestra.map.Map m3 : maps2) {
																							if (m3.getPlaces()
																									.equalsIgnoreCase(
																											"")
																									|| m3.getPlaces()
																					...
																					if (command.equalsIgnoreCase(
																						...
																						final Map<Integer, Map<String, Map<String, Integer>>> extras = World
																								.getExtraMonsters();
																						final Map<Short, org.cestra.map.Map> maps3 = World
																								.getMaps();
																						for (final Map.Entry<Integer, Map<String, Map<String, Integer>>> entry17 : extras
																								.entrySet()) {
																							final Integer idMob = entry17
																									.getKey();
																							for (final Map.Entry<Short, org.cestra.map.Map> entry18 : maps3
																									.entrySet()) {
																								final org.cestra.map.Map map6 = entry18
																										.getValue();
