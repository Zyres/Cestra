...
public class Case {
	...
	private org.cestra.object.Object droppedItem;

	public Case(final org.cestra.map.Map map, final int id, final boolean walkable, final boolean loS,
			final int objId) {
		this.walkable = true;
	...
	public void addOnCellStopAction(final int id, final String args, final String cond, final org.cestra.map.Map map) {
	...
	public void addDroppedItem(final org.cestra.object.Object obj) {
		this.droppedItem = obj;
	}

	public org.cestra.object.Object getDroppedItem(final boolean delete) {
		final org.cestra.object.Object obj = this.droppedItem;
		if (delete) {
	...
	public void startAction(final Player perso, final GameAction GA) {
		...
		if (!JobConstant.isJobAction(actionID) || perso.get_fight() != null) {
			...
			case 102: {
				...
				final org.cestra.map.Map _map = perso.getCurMap();
				perso.getWaiter().addNext(new Runnable() {
					...
					public void run() {
						...
						final org.cestra.object.Object obj = World.getObjTemplate(311).createNewItem(qua, false);
