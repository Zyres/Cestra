...
import org.cestra.client.other.Group;
...
import org.cestra.entity.npc.Npc;
...
public class SocketManager {
	...
	public static void GAME_SEND_UPDATE_ITEM(final Player P, final org.cestra.object.Object obj) {
	...
	public static void GAME_SEND_UPDATE_OBJECT_DISPLAY_PACKET(final Player perso, final org.cestra.object.Object item) {
		final StringBuilder packet = new StringBuilder();
	...
	public static void GAME_SEND_MAP_MOBS_GMS_PACKETS(final GameClient out, final org.cestra.map.Map Map) {
	...
	public static void GAME_SEND_MAP_OBJECTS_GDS_PACKETS(final GameClient out, final org.cestra.map.Map Map) {
	...
	public static void GAME_SEND_MAP_NPCS_GMS_PACKETS(final GameClient out, final org.cestra.map.Map Map) {
	...
	public static void GAME_SEND_MAP_PERCO_GMS_PACKETS(final GameClient out, final org.cestra.map.Map Map) {
	...
	public static void GAME_SEND_MAP_GMS_PACKETS(final GameClient out, final org.cestra.map.Map Map) {
		final String packet = Map.getGMsPackets(out.getPersonnage());
		send(out, packet);
	}

	public static void GAME_SEND_ERASE_ON_MAP_TO_MAP(final org.cestra.map.Map map, final int guid) {
		if (map == null) {
			return;
		}
	...
	public static void GAME_SEND_ADD_PLAYER_TO_MAP(final org.cestra.map.Map map, final Player perso) {
	...
	public static void GAME_SEND_MAP_NEW_DUEL_TO_MAP(final org.cestra.map.Map map, final int guid, final int guid2) {
	...
	public static void GAME_SEND_CANCEL_DUEL_TO_MAP(final org.cestra.map.Map map, final int guid, final int guid2) {
	...
	public static void GAME_SEND_MAP_START_DUEL_TO_MAP(final org.cestra.map.Map map, final int guid, final int guid2) {
	...
	public static void GAME_SEND_MAP_FIGHT_COUNT(final GameClient out, final org.cestra.map.Map map) {
	...
	public static void GAME_SEND_MAP_FIGHT_COUNT_TO_MAP(final org.cestra.map.Map map) {
		final String packet = "fC" + map.getNbrFight();
		for (final Player z : map.getPersos()) {
			send(z, packet);
		}
	...
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_MAP(final org.cestra.map.Map map, final int arg1,
	...
	public static void GAME_SEND_GAME_ADDFLAG_PACKET_TO_PLAYER(final Player p, final org.cestra.map.Map map,
	...
	public static void GAME_SEND_GAME_REMFLAG_PACKET_TO_MAP(final org.cestra.map.Map map, final int guid) {
	...
	public static void GAME_SEND_ADD_IN_TEAM_PACKET_TO_MAP(final org.cestra.map.Map map, final int teamID,
			final Fighter perso) {
		final StringBuilder packet = new StringBuilder();
	...
	public static void GAME_SEND_ADD_IN_TEAM_PACKET_TO_PLAYER(final Player p, final org.cestra.map.Map map,
	...
	public static void GAME_SEND_REMOVE_IN_TEAM_PACKET_TO_MAP(final org.cestra.map.Map map, final int teamID,
			final Fighter perso) {
		final StringBuilder packet = new StringBuilder();
		packet.append("Gt").append(teamID).append("|-").append(perso.getId()).append(";").append(perso.getPacketsName())
				.append(";").append(perso.getLvl());
	...
	public static void GAME_SEND_MAP_MOBS_GMS_PACKETS_TO_MAP(final org.cestra.map.Map map) {
		final String packet = map.getMobGroupGMsPackets();
		for (final Player z : map.getPersos()) {
			send(z, packet);
		}
	...
	public static void GAME_SEND_MAP_MOBS_GMS_PACKETS_TO_MAP(final org.cestra.map.Map map, final Player perso) {
		final String packet = map.getMobGroupGMsPackets();
		send(perso, packet);
	}

	public static void GAME_SEND_MAP_MOBS_GM_PACKET(final org.cestra.map.Map map, final Monster.MobGroup current_Mobs) {
		String packet = "GM|";
	...
	public static void GAME_SEND_MAP_GMS_PACKETS(final org.cestra.map.Map map, final Player _perso) {
		final String packet = (_perso.get_fight() != null) ? map.getFightersGMsPackets(_perso.get_fight())
				: map.getGMsPackets(_perso);
		send(_perso, packet);
	}

	public static void GAME_SEND_ON_EQUIP_ITEM(final org.cestra.map.Map map, final Player _perso) {
	...
	public static void GAME_SEND_FIGHT_CHANGE_PLACE_PACKET_TO_FIGHT(final Fight fight, final int teams,
			final org.cestra.map.Map map, final int guid, final int cell) {
	...
	public static void GAME_SEND_GM_MOUNT_TO_MAP(final org.cestra.map.Map map, final Dragodinde dd) {
	...
	public static void GAME_SEND_GDO_OBJECT_TO_MAP(final GameClient out, final org.cestra.map.Map map) {
	...
	public static void GAME_SEND_GM_MOUNT(final GameClient out, final org.cestra.map.Map map) {
	...
	public static void GAME_SEND_GA_ACTION_TO_MAP(final org.cestra.map.Map mapa, final String idUnique,
	...
	public static void SEND_GDO_PUT_OBJECT_MOUNT(final org.cestra.map.Map map, final String str) {
	...
	public static void SEND_GDE_FRAME_OBJECT_EXTERNAL(final org.cestra.map.Map map, final String str) {
	...
	public static void GAME_SEND_FIGHT_CHANGE_OPTION_PACKET_TO_MAP(final org.cestra.map.Map map, final char s,
	...
	public static void GAME_SEND_Im_PACKET_TO_MAP(final org.cestra.map.Map map, final String id) {
	...
	public static void GAME_SEND_eUK_PACKET_TO_MAP(final org.cestra.map.Map map, final int guid, final int emote) {
	...
	public static void GAME_SEND_MESSAGE_TO_MAP(final org.cestra.map.Map map, final String mess, final String color) {
		final String packet = "cs<font color='#" + color + "'>" + mess + "</font>";
		for (final Player z : map.getPersos()) {
			send(z, packet);
		}
	...
	public static void GAME_SEND_EMOTICONE_TO_MAP(final org.cestra.map.Map map, final int guid, final int id) {
	...
	public static void GAME_SEND_MAP_FIGHT_GMS_PACKETS(final Fight fight, final org.cestra.map.Map map,
			final Player _perso) {
		final String packet = map.getFightersGMsPackets(fight);
		send(_perso, packet);
	}
	...
	public static void GAME_SEND_FIGHT_LIST_PACKET(final GameClient out, final org.cestra.map.Map map) {
		final StringBuilder packet = new StringBuilder();
		packet.append("fL");
	...
	public static void GAME_SEND_cMK_PACKET_TO_MAP(final org.cestra.map.Map map, final String suffix, final int guid,
	...
	public static void GAME_SEND_eD_PACKET_TO_MAP(final org.cestra.map.Map map, final int guid, final int dir) {
	...
	public static void GAME_SEND_OBJECT_QUANTITY_PACKET(final Player out, final org.cestra.object.Object obj) {
		final String packet = "OQ" + obj.getGuid() + "|" + obj.getQuantity();
		send(out, packet);
	}

	public static void GAME_SEND_OAKO_PACKET(final Player out, final org.cestra.object.Object obj) {
		final String packet = "OAKO" + obj.parseItem();
		send(out, packet);
	}

	public static void SEND_OAKO_PACKET(final GameClient out, final org.cestra.object.Object obj) {
		final String packet = "OAKO" + obj.parseItem();
		send(out, packet);
	}
	...
	public static void GAME_SEND_OBJET_MOVE_PACKET(final Player out, final org.cestra.object.Object obj) {
	...
	public static void GAME_SEND_GDF_PACKET_TO_MAP(final org.cestra.map.Map map, final Case cell) {
	...
	public static void GAME_SEND_GA_PACKET_TO_MAP(final org.cestra.map.Map map, final String gameActionID,
	...
	public static void GAME_SEND_IO_PACKET_TO_MAP(final org.cestra.map.Map map, final int guid, final String str) {
	...
	public static void GAME_SEND_ALTER_GM_PACKET(final org.cestra.map.Map map, final Player perso) {
		final String packet = "GM|~" + perso.parseToGM();
		for (final Player z : map.getPersos()) {
			if (perso.get_size() > 0) {
				send(z, packet);
	...
	public static void GAME_SEND_ADD_NPC_TO_MAP(final org.cestra.map.Map map, final Npc npc) {
		for (final Player z : map.getPersos()) {
			send(z, "GM|" + npc.parse(false, z));
		}
	}

	public static void GAME_SEND_ADD_PERCO_TO_MAP(final org.cestra.map.Map map) {
	...
	public static void GAME_SEND_GDO_PACKET_TO_MAP(final org.cestra.map.Map map, final char c, final int cell,
	...
	public static void GAME_SEND_FLAG_PACKET(final Player perso, final org.cestra.map.Map CurMap) {
	...
	public static void GAME_SEND_WEDDING(final org.cestra.map.Map c, final int action, final int homme, final int femme,
			final int parlant) {
	...
	public static void SEND_GM_PRISME_TO_MAP(final GameClient out, final org.cestra.map.Map Map) {
	...
	public static void GAME_SEND_PRISME_TO_MAP(final org.cestra.map.Map Map, final Prism Prisme) {
	...
	public static void SEND_GA_ACTION_TO_Map(final org.cestra.map.Map Map, final String gameActionID,
			final int actionID, final String s1, final String s2) {
		String packet = "GA" + gameActionID + ";" + actionID + ";" + s1;
		if (!s2.equals("")) {
			packet = String.valueOf(packet) + ";" + s2;
	...
	public static void GAME_SEND_ACTION_TO_DOOR(final org.cestra.map.Map map, final int args, final boolean open) {
		String packet = "";
		if (open) {
			packet = "GDF|" + args + ";2";
		} else if (!open) {
	...
	public static void GAME_UPDATE_CELL(final org.cestra.map.Map map, final String args) {
	...
	public static void GAME_SEND_ACTION_TO_DOOR_PEUR(final org.cestra.map.Map map, final boolean open) {
		String packet = "";
		if (open) {
	...
	public static void GAME_SEND_FIGHT_OBJECTS_GDS_PACKETS(final org.cestra.map.Map map, final Fight fight) {
	...
	public static void GAME_SEND_FIGHT_OBJECTS_GDS_END_PACKETS(final org.cestra.map.Map map, final Fight fight) {
	...
	public static void sendPacketToMap(final org.cestra.map.Map map, final String packet) {
		for (final Player perso : map.getPersos()) {
			send(perso, packet);
		}
	}

	public static void sendPacketToMapGM(final org.cestra.map.Map map, final Npc npc) {
		for (final Player perso : map.getPersos()) {
